...
const getJugadores = async (req, res) => {
  try {
    ...
    // Limpiar los datos
    const cleanedJugadores = jugadores.map(jugador => ({
      id: jugador.id,
      ...
      categoria_id: jugador.Categorium.dataValues.id,
      categoria: jugador.Categorium.dataValues.nombre, // Solo enviar el nombre de la categoría
